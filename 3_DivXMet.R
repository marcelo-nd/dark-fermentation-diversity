...
# Load Data
####################################################################################
alta_diversidad <- read.csv("C:/Users/Marcelo/OneDrive - UT Cloud/Doctorado/DiversidadH2/Análisis/2_resultados/altad_otu_table.csv", row.names = 1)

metabolite_data <- read.csv("C:/Users/Marcelo/OneDrive - UT Cloud/Doctorado/DiversidadH2/Análisis/2_resultados/metabolite_data.csv", row.names = 1)
